...
import com.arvin.koalapush.listener.ReceivedListenerImp;
import com.arvin.koalapush.net.MyRequest;
import com.arvin.koalapush.potter.IBindService;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			Kpush push = Kpush.getInstence().create(mContext)
			 .showLog(true)
			 .showToast(true)
			 .setTimeout(30)
			 .setRecoverTimes(5)
...
//			 mClientId.setText(push.getClientId());
			...
			ReceivedListener listener = new ReceivedListenerImp(mContext);
		...
		case R.id.recover:
			...
			break;
		case R.id.show_clientid:
			mClientId.setText(Kpush.getClientId());
			break;
		default:
			break;
		}
