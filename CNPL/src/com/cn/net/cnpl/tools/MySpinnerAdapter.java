...
public class MySpinnerAdapter<T> extends BaseAdapter implements Filterable {
	/**
	 * Contains the list of objects that represent the data of this
	 * MySpinnerAdapter. The content of this list is referred to as "the array"
	...
	private View createViewFromResource(int position, View convertView,
		...
		try {
			...
			Log.e("MySpinnerAdapter",
					"You must supply a resource ID for a TextView");
			throw new IllegalStateException(
					"MySpinnerAdapter requires the resource ID to be a TextView",
					e);
		}

		T item = getItem(position);
		if (item instanceof CharSequence) {
			if (resource == mDropDownResource) {
	...
	/**
	 * Creates a new MySpinnerAdapter from external resources. The content of
	 * the array is obtained through
	 ...
	 * 
	 * @return An MySpinnerAdapter<CharSequence>.
	 */
	public static MySpinnerAdapter<CharSequence> createFromResource(
			Context context, int textArrayResId, int textViewResId) {
		CharSequence[] strings = context.getResources().getTextArray(
				textArrayResId);
		return new MySpinnerAdapter<CharSequence>(context, textViewResId,
				strings);
	}
