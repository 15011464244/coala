...
public class MailHandDetailHelper extends BaseSQLiteOpenHelper implements DatabaseConstants {
	...
	protected static final String CREATESQL ="create table tb_mail_hand_detail(mail_num varcahr(20)," +
			...
			"code2d_num number,paper_num number,operatorType char(1),oldSid long, signatureImg clob);";

	public MailHandDetailHelper(Context context, String name, CursorFactory factory,
			int version) {
