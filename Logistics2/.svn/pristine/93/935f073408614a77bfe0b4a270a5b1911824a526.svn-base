...
//	 public static final String SERVER_ROOT = "http://192.168.253.14:8080/message-service/";
//	 public static final String SERVER_ROOT = "http://172.30.184.8:8080/message-service/";
	/**
	 * 登录
	 */
	 ...
	 * 时效查询
	 */
	public static final String TimeQuery = SERVER_ROOT + "UtilsAction/API/timequery";
	/**
	 * 查询下段信息
	 */
