...
import com.ems.express.ui.check.ResultAdapter;
import com.ems.express.util.ToastUtil;
/**
 * 快递详情
 */
public class ExpressDetailActivity extends Activity implements OnClickListener {
//	private Context mContext = ExpressDetailActivity.this;
...
//		mLinCare.setOnClickListener(this);
	...
	public void loadData() {
		...
		mData.add(bean2);
		mData.add(bean3);
		mAdapter = new ResultAdapter(ExpressDetailActivity.this, mData);
