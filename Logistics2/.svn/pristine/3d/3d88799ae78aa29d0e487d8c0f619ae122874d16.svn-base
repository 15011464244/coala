package com.ems.express.baidupush;
...
//				+ "\" customContentString="+ customContentString;
	...
	private void updateContent(Context context, String content) {
		...
		App.mBaiduPushData.add(new MessageCenterItemBean("",msg,"","",""));
		
		App.getmChatService().sendBaiduPush(content);
		
//		MessageCenterActivity.sHandler.sendEmptyMessage(1);
